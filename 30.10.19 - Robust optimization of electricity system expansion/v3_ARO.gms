...
parameters
Tol         decomposition tolerance / 1e-9 /
...
EQ_genCAP(g,vv)..           PG_M(g,vv)    =L= GDATA(g,"PEmax");
...
EQ_ARO_Ubudg..      SUM(d, Pdem(d) - DDATA(d,"PDmin")) / SUM(d, DDATA(d,"PDmax") - DDATA(d,"PDmin")) =L= GAMMA;
...
execute_unload "ARO_results.gdx"
