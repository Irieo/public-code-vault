...
\title{Insights from model based studies \\ on 24/7 CFE procurement and green hydrogen regulation}
...
\begin{frame}{Spatio-temporal load shifting for truly clean computing}, 
	...
	\begin{columns}[T]
	 ...
	 \hrefc{https://arxiv.org/abs/2405.00036}{Working paper (2024)} \\
	 \hrefc{https://github.com/Irieo/space-time-optimization}{Code}

		\source{Riepin, Brown \& Zavala (2024)}
...
\begin{frame}
  \frametitle{Research on datacenter load flexibility}

  % First image in the top left corner
  \begin{textblock*}{0.4\textwidth}(0cm,1cm)
    \includegraphics[width=9cm]{images/lindberg-paper.png}
  \end{textblock*}

  % Second image, appearing lower and to the right
  \begin{textblock*}{0.4\textwidth}(6cm,4cm) %
    \includegraphics[width=9cm]{images/Zheng-paper.png}
  \end{textblock*}

  \source{
    Lindberg et al. (2022): \hrefc{https://doi.org/10.1016/j.epsr.2022.108586}{doi.org/10.1016/j.epsr.2022.108586}, \\
    Zheng et al. (2020): \hrefc{https://doi.org/10.1016/j.joule.2020.08.001}{doi.org/10.1016/j.joule.2020.08.001}
  }

\end{frame}


\begin{frame}{Market data and forecasts}

    \centering
    \includegraphics[width=10.5cm]{images/electricity-maps.png}

    \source{
      Carbon intensity of electricity consumed\\
      Source: \hrefc{https://app.electricitymaps.com/map}{electricitymaps.com/map}
      }
...
\begin{frame}{Time-series of optimized spatial load shifts (locations: DK-PT-GR)}
	\centering
...
%   \begin{frame}{Results can be generalized beyond specific load locations}
% 	\centering
% 	\includegraphics[width=13cm]{images/flexibility_vs_normalized_costs.pdf}
%   \end{frame}
  

\begin{frame}{More insights in the published works}

\enquote{Spatio-temporal load shifting for truly clean computing} (Mar 2024): \\
paper: \hrefc{https://arxiv.org/abs/2405.00036}{https://arxiv.org/abs/2405.00036} \\
code: \hrefc{https://github.com/Irieo/space-time-optimization}{https://github.com/Irieo/space-time-optimization}

\enquote{The value of space-time load-shifting flexibility for 24/7 CFE procurement} (July 2023): \\
study: \hrefc{https://zenodo.org/records/8185850}{https://zenodo.org/records/8185850}\\
code: \hrefc{https://github.com/PyPSA/247-cfe/tree/v0.3}{https://github.com/PyPSA/247-cfe/tree/v0.3}
...
\begin{frame}{On hourly matching, grid signals and load flexibility \\ Fraction of hourly demand met by CFE}
	...
	\source{Riepin and Brown (2023): https://zenodo.org/records/10407831}
\end{frame}
